...
class DocsAgentService
  ...
  def run
    ...
    # Lazy load GTM positioning and work items if not provided
    @gtm_positioning ||= read_gtm_positioning
    @work_items ||= WorkItem.tasks
  ...
  def update_stack_doc
    ...
    content = <<~MARKDOWN
      ...
      *Generated by Docs Agent on #{Time.current.to_fs(:long)}*
    MARKDOWN
